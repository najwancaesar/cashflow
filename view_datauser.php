                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="kode_user"
                                                            value="<?php echo $kode_otomatis ?>" readonly required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Pemilik
                                                            User</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="login-horizental cancel-wp pull-left">
                                                                <a href="main.php?module=pelayanan"
                                        ...
                                        <form method="POST" action="aksi_user.php?act=e">
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="kode_user"
                                                            value="<?php echo $pelayanan['kode_user'] ?>" readonly
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="nama"
                                                            value="<?php echo $pelayanan['nama'] ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="username"
                                                            value="<?php echo $pelayanan['username'] ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="password"
                                                            value="<?php echo $pelayanan['password'] ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <select class="form-control" name="role" required>
                                                            <option value="<?php echo $pelayanan['role'] ?>">
                                                                <?php echo $pelayanan['role'] ?></option>
                                                            <option value="">- Pilih role User -</option>
                                                            <option value="Admin">Admin</option>
                                                            <option value="Bidan">Bidan</option>
                                                            <option value="Direktur">Direktur</option>
                ...
                <div class="sparkline13-list shadow-reset">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div id="toolbar">
                                <a href="main.php?module=datauser&act=t" type="button"
                                    class="btn btn-custon-four btn-primary btn-md">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="main.php?module=datauser&act=e&id=<?php echo $row['kode_user'] ?>"
