...
class TCPDF {
	 ...
	 * @protected
	 */
	protected $header_logo = 'plugins/tcpdf/examples/images/tcpdf_logo.png';
	 ...
	 * @protected
	 */
	protected $header_title = 'YAMAHA MATARAM SAKTI';
	 ...
	 * @public
	 */
	public function setHeaderData($ln='', $lw=1, $ht='', $hs='', $tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->header_logo = $ln;
