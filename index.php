...
<head>
  ...
  <style>
    ...
    body {
      ...
      color: var(--text);
      background: radial-gradient(circle at top left, rgba(15, 159, 116, .08), transparent 28%), radial-gradient(circle at top right, rgba(29, 119, 255, .10), transparent 32%), linear-gradient(180deg, #fbfffd 0%, #f4f8fc 100%)
    }
    ...
    .eyebrow {
      ...
      gap: 10px;
      padding: 10px 16px;
      border: 1px solid rgba(15, 159, 116, .16);
      border-radius: 999px;
    ...
    .eyebrow:before {
      ...
      height: 8px;
      border-radius: 50%;
      background: linear-gradient(135deg, var(--green), #43d9a5)
    }
    ...
    .brand-mark {
      ...
      box-shadow: 0 14px 28px rgba(29, 119, 255, .18)
    }
    ...
    .btn-soft {
      background: rgba(29, 119, 255, .08);
      border-color: rgba(29, 119, 255, .08);
      color: var(--blue)
    }
    ...
    .btn-solid {
      background: linear-gradient(135deg, var(--green), var(--blue));
      color: #fff;
      box-shadow: 0 18px 34px rgba(29, 119, 255, .22)
    }
    ...
    .balance-card {
      grid-column: span 7;
      background: linear-gradient(145deg, #0f172a, #193759);
      color: #fff
    }
    ...
    .bars span {
      ...
      background: linear-gradient(180deg, rgba(29, 119, 255, .22), rgba(15, 159, 116, .82))
    }
    ...
    .mini-card {
      grid-column: span 5;
      background: linear-gradient(180deg, rgba(29, 119, 255, .08), rgba(15, 159, 116, .08))
    }
    ...
    .feature-icon {
      background: linear-gradient(135deg, rgba(15, 159, 116, .14), rgba(29, 119, 255, .16));
      color: var(--blue)
    }

    .benefit-icon {
      background: rgba(15, 159, 116, .12);
      color: var(--green-deep)
    }
    ...
    .line-chart {
      ...
      margin-top: 18px;
      border-radius: 20px;
      background: linear-gradient(180deg, rgba(29, 119, 255, .05), transparent), repeating-linear-gradient(to top, rgba(15, 23, 42, .05) 0, rgba(15, 23, 42, .05) 1px, transparent 1px, transparent 54px);
      overflow: hidden
    }
    ...
    .contact-form .form-control:focus {
      border-color: rgba(29, 119, 255, .34);
      background: #fff;
      box-shadow: 0 0 0 4px rgba(29, 119, 255, .08)
    }
      ...
      <div class="container">
        <div class="stats">
          ...
          <div class="stat-card fade d2">
            ...
            <p class="muted-copy">Pemasukan, pengeluaran, saldo, laporan, kategori, dan analisis dalam satu sistem.</p>
          </div>
          ...
          <div class="stat-card fade d4">
            ...
            <p class="muted-copy">Hierarki visual yang jelas membuat user baru langsung paham arah produknya.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="benefits mt-5">
          <div class="benefit-card fade d1"><span class="benefit-icon"><i class="fa fa-eye"></i></span>
            ...
            <p class="muted-copy">Angka penting langsung terlihat tanpa harus membaca terlalu banyak detail.</p>
          </div>
          <div class="benefit-card fade d2"><span class="benefit-icon"><i class="fa fa-clock-o"></i></span>
            <h4>Hemat Waktu Operasional</h4>
            <p class="muted-copy">Pencatatan harian jadi lebih cepat sehingga user bisa fokus pada keputusan.</p>
          </div>
        ...
        <div class="contact-shell">
            ...
            <div class="contact-list">
              <div class="contact-item"><i class="fa fa-envelope-o"></i>
                <div><strong>Email</strong>
                  <div class="text-muted">KINCompany@gmail.co.id</div>
                </div>
              </div>
              <div class="contact-item"><i class="fa fa-phone"></i>
                <div><strong>Phone</strong>
                  <div class="text-muted">+62 812 87892110451</div>
                </div>
              </div>
              <div class="contact-item"><i class="fa fa-map-marker"></i>
                <div><strong>Location</strong>
                  <div class="text-muted">Indonesia • Politeknik Gajah Tunggal</div>
                </div>
              </div>
            </div>
          </div>
          <div class="contact-form fade d2">
            <form id="contactForm" method="POST">
              <input type="hidden" name="access_key" value="288e98f4-6276-4f20-af9d-c7f3b63f0821">
              <input type="hidden" name="from_name" value="CashFlow Control">
              <input type="hidden" name="subject" value="Pesan Baru dari Landing Page CashFlow Control">
              ...
              <button type="submit" class="btn-solid w-100 border-0">
                Kirim Pesan <i class="fa fa-paper-plane-o"></i>
              </button>
            </form>
          </div>
        </div>
  ...
  <script>
    ...
    if (contactForm) {
      ...
      contactForm.addEventListener('submit', async function(event) {
        ...
        submitBtn.innerHTML = 'Mengirim... <i class="fa fa-spinner fa-spin"></i>';
        ...
        try {
          ...
          if (response.ok && data.success) {
            if (typeof Swal !== 'undefined') {
              Swal.fire({
                ...
                text: 'Terima kasih! Pesan kamu sudah masuk dan akan segera dibaca.',
          ...
          if (typeof Swal !== 'undefined') {
            Swal.fire({
              ...
              text: 'Pesan belum terkirim. Periksa koneksi internet lalu coba lagi.',
              confirmButtonColor: '#ef4444'
            });
          } else {
