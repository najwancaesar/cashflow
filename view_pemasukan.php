                ...
                <div class="card-body px-0 pb-2">
                    ...
                    <div class="table-responsive p-4 mx-2">
                        <table class="table align-items-center mb-0" id="datatable">
                            ...
                            <?php
                            $sql = mysqli_query($con, "select * from pemasukan join user on pemasukan.user = user.id_user where user.id_user = $userYangSedangLogin");
                            $no = 1;
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span
                                            ...
                                            <?php if ($row['status'] == 'selesai'): ?>
                                                <?= $row['status'] ?>
                                            <?php else : ?>
                                                <a href="aksi_pemasukan.php?act=l&id=<?php echo $row['id_pemasukan'] ?>"
                                                    class="text-white">
                                                    <?= $row['status'] ?>
                                                </a>
                                            <?php endif ?>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <a type="submit" data-id="<?php echo $row['id_pemasukan'] ?>"
